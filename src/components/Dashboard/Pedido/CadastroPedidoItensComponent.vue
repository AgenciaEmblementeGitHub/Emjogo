<template>
    <div id="cadastro-de-produto">
        ...
        <div style="margin: 34px 0px; display: flex; flex-direction: row; justify-content: flex-start; flex-wrap: wrap;">
            <p style="color: #181818;">Cadastro de Pedido Itens</p>      
        </div>  
        ...
        <div style="display: flex; justify-content: space-between; margin-bottom: 55px;">
            <div style="width: 30%; height: auto; border: 2px solid #80808021; border-radius: 2px; box-sizing: border-box; padding: 21px;">
                ...
                <div>
                    <label for="orderItem">Valor do Produto:</label>
                    <br>
                    <input @input="fixedSring()" type="text" name="productPrice" style="border: 1px solid #80808021; height: 23px;" v-model="this.orderItem.product_price">                
                </div>                     
            </div>
            ...
            <div style="width: 65%; height: auto; border: 2px solid #80808021; border-radius: 2px; box-sizing: border-box; padding: 21px;">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr style="width: 100%; display: flex; justify-content: space-between; margin-top: 21px;">
                            <td style="width: 100%;">
                                ...
                                <textarea name="" id="" cols="30" rows="10" style="width: 100%; text-align: left;" v-model="orderItem.details"></textarea>
                            </td>
                        </tr>                     
                    </table>
                ...
                <div style="width: 100%; heght: 40px; display: flex; justify-content: flex-start; margin-top: 21px;">  
                    ...
                    <!--<button class="button back-color-green"   @click="FinishOrder()" :disabled="FieldIsEmpty(responseItem.id)" :class="{'btn-disabled': (order <= 0)}">Finalizar</button>-->
        ...
        <table style="width: 100%; height: 100%; display: table;">
            <tr style="width: 100%; height: 34px; display: flex; justify-content: space-between; font-size: 13px; border-bottom: 1px solid #80808021; margin-bottom:21px;">
                ...
                <td style="width: 50px;">Remover</td>
            </tr>
            ...
            <div style="width:100%;height:400px; overflow: scroll;">
                <tr style="width: 100%; height: 45px; align-items: center; display: flex; justify-content: space-between; font-size: 13px; border-bottom: 1px solid #80808021; margin:21px 0px; padding-bottom:21px" v-for="value in order" :key="value.id">
                    ...
                    <td style="width: 50px;">
                        <input type="text" style="width:100%;" v-model="value.orderItem.size_10">
                    </td>                                              
                    
                    <td style="width: 50px;">
                        <input type="text" style="width:100%;" v-model="value.orderItem.product_price">
                    </td>                                     

                    <td style="width: 50px;">
                        <button style="width: 100%;" class="del-btn" @click="RemoveItem(value.orderItem.id)">X</button>
                    </td> 
                </tr> 
            </div>           
        </table>
...
export default {
    ...
    methods:{
        ...
        CreateOrder(){
            ...
            if(this.orderItem.product_price == null){
                this.toast.error(`Favor informar o valor do produto.`);
                return;
            }else if(this.orderItem.size_1 == 0 && this.orderItem.size_2 ==  0 && 
                    this.orderItem.size_3 == 0 && this.orderItem.size_4 ==  0 && 
                    this.orderItem.size_5 == 0 && this.orderItem.size_6 ==  0 && 
                    this.orderItem.size_7 == 0 && this.orderItem.size_8 ==  0 && 
                    this.orderItem.size_9 == 0 && this.orderItem.size_10 == 0){
                this.toast.error(`Favor informar ao menos uma quantidade.`);
                return;                
            }
            ...
            let bodyToSend = {
                ...
                description:this.responseItem.description,
                details:this.orderItem.details,
            ...
            OService.Insert_New_Order_item(bodyToSend)
            .then(function () {
                _this.toast.success(`Pedido salvo com sucesso!`);
            })  
