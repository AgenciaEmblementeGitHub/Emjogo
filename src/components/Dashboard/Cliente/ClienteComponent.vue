    ...
    <div>
        <div id="cadastro-de-cliente">
            ...
            <div style="margin-top: 34px; display: flex; flex-direction: row; justify-content: flex-start; flex-wrap: wrap;">
                <button class="button back-color-blue" @click="CadastraClienteSistema()">Cadastrar Cliente</button>
                <button class="button back-color-red" @click="LimparCampos()">Limpar Campos</button>
            </div>            
        </div>
    </div>
</template>
...
export default {
    ...
    methods:{
        ...
        CadastraClienteSistema()
        {
            //Service.CadastrarClienteSistema([this.fieldForm.personalData, this.fieldForm.contactData, this.fieldForm.addresData, this.fieldForm.comercialData]);
            let _vue = this;
            _vue.isLoading = !_vue.isLoading;

                fetch('http://agenciaemblemente.com/api/cliente/cadastrarCliente',{
                    method: 'POST',
                    headers: {
                ...
                .then(function(){
                    _vue.isLoading = !_vue.isLoading;
                    _vue.toast.success(`Cliente cadastrado com sucesso!`)
                })        
